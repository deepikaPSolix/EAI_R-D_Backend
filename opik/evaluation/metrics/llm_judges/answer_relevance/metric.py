...
class AnswerRelevance(base_metric.BaseMetric):
    ...
    def score(
        ...
        # print("Metric.py -> Score function print the llm query :  ",llm_query)

        # print("-------------")

        # print("Metric.py -> Score function print the model op :  ",model_output)
    ...
    def _parse_model_output(self, content: str) -> score_result.ScoreResult:
        #print("Metric.py -> parseModelOp function print the conetent :  ",content)
        # print("----------------------")
        # print(type(content))
        ...
        score_match = re.search(r'\"answer_relevance_score\":\s*([\d.]+)', content)
